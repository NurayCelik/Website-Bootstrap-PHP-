...
class Cart{
 ...
 public function addToCart($quantity, $id){
 	$quantity = $this->fm->validation(strip_tags(addslashes($quantity)));  // add Format Class validation 
...
public function updateCartQuantity($cartId, $quantity){
  ...
  $query = "UPDATE tbl_cart
              ...
              if ($update_row) {
                header("Location:cart.php");//aynı sayfaya yönlendiriyoruz sepet bilgilerini gencellenmiş halini sayfada göstermeye yardım için.
              }else {
