...
$page  = new Pages();
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['guncelle'])) { 
       ...
       $updatedAboutTop = $page->aboutTopUpdate($_POST, $images);
    }
              ...
              <div class="x_content">
                ...
                <form action="" method="POST" id="demo-form2" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="first-name" required="required" name="icerik1" value="<?php echo $fm->validation($value['icerik1']); ?>" class="form-control col-md-7 col-xs-12">
                    </div>

                    </div>
                                 <div class="form-group">
                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">İçerik2<span class="required">*</span>
                    </label>
                    <div class="col-md-9 col-sm-9 col-xs-12">

                     <input type="text" id="first-name" required="required" name="icerik2" value="<?php echo $fm->validation($value['icerik2']); ?>" class="form-control col-md-7 col-xs-12">
                    </div>

                    </div>
                
                  <div class="form-group">
                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">İçerik3<span class="required">*</span>
                    </label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="text" id="first-name" required="required" name="icerik3" value="<?php echo $fm->validation($value['icerik3']); ?>" class="form-control col-md-7 col-xs-12">
                  </div>
